...
const routes = [
    ...
    {
        path: 'test',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_test_test_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./test/test.module */ 2432)).then(m => m.TestPageModule)
    },
];
...
/* harmony import */ var _D_callkit_sample_sample_test_ionic_sample_test_ionic_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !./node_modules/@ngtools/webpack/src/loaders/direct-resource.js!./app.component.html */ 5158);
...
/* harmony import */ var capacitor_callkit_voip__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! capacitor-callkit-voip */ 8830);
...
let AppComponent = class AppComponent {
    constructor(platform, route, zone) {
    ...
    registerVoipNotification() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__awaiter)(this, void 0, void 0, function* () {
            // register token
            capacitor_callkit_voip__WEBPACK_IMPORTED_MODULE_2__.CallKitVoip.addListener('registration', (({ token }) => console.log(`VOIP token has been received ${token}`)));
            capacitor_callkit_voip__WEBPACK_IMPORTED_MODULE_2__.CallKitVoip.addListener('callAnswered', (({ username, connectionId }) => {
            ...
            capacitor_callkit_voip__WEBPACK_IMPORTED_MODULE_2__.CallKitVoip.addListener('callStarted', (({ username, connectionId }) => {
                // handle call (e.g. redirect it to specific page with call)
                console.log(`Call has been started with ${username} (connectionId: ${connectionId})`);
            }));
            // init plugin, start registration of VOIP notifications
            yield capacitor_callkit_voip__WEBPACK_IMPORTED_MODULE_2__.CallKitVoip.register(); // can be used with `.then()`
...
AppComponent = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_6__.Component)({
        selector: 'app-root',
        template: _D_callkit_sample_sample_test_ionic_sample_test_ionic_node_modules_ngtools_webpack_src_loaders_direct_resource_js_app_component_html__WEBPACK_IMPORTED_MODULE_0__["default"],
